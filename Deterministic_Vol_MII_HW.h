...
//  Deterministic_Vol_MII_HW.h
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
#ifndef Deterministic_Vol_MII_HWH
#define Deterministic_Vol_MII_HWH
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
class Deterministic_Vol_MII_HW : public DeterministicVolatilityBase
{
	public:
		Deterministic_Vol_MII_HW();
