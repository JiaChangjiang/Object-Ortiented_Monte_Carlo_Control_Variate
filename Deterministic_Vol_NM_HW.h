...
//  Deterministic_Vol_NM_HW.h
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
#ifndef Deterministic_Vol_NM_HWH
#define Deterministic_Vol_NM_HWH
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
class Deterministic_Vol_NM_HW : public DeterministicVolatilityBase
{
	public:
		Deterministic_Vol_NM_HW();
